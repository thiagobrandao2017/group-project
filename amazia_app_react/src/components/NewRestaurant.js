            ...
            <div>
                ...
                <div className="container well small-container margin-top-20">
                  <form onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <div className="margin-top-10">
                        <input onChange={this.handleChange.bind(this)} name="img" type="text" className="form-control" />
                    </div>
                    <div className="bold margin-top-10">
                        Type
                    </div>
                    ...
                    <div className="margin-top-10">
                        <input onChange={this.handleChange.bind(this)} name="desc" type="text" className="form-control" />
                    </div>
                    <div className="bold margin-top-10">
                        Rating
                    </div>
                    ...
                    <div className="margin-top-10">
                        <input onChange={this.handleChange.bind(this)} name="created_by" type="text" className="form-control" />
                    </div>
                    <div className="bold margin-top-10">
                        NYC Location
                    </div>
                    <div className="margin-top-10">
                        <input onChange={this.handleChange.bind(this)} name="location" type="text" className="form-control" />
                    </div>
